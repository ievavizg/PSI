...
\begin{document}
	...
	Šiame skyriuje pateikiami užduoties „Registruotis” testavimo scenarijai.
	\begin{table}[H]
		\caption{Funkciniai reikalavimai. Internetinės svetainės langai.}
		\begin{tabular}{|p{6cm}|p{11cm}|}
			...
			{Sėkminga kliento registracija}\\
			\hline
			\multicolumn{1}{|c|}{{\bfseries Sąlygos prieš vykdymą}}&
			{1. Atidarytas registracijos langas.}\\
			\hline
			\multicolumn{1}{|c|}{{\bfseries Vykdomi žingsniai}}&
			{1. Įvesti vardą, pavardę, el.paštą, slapyvardį, adresą ir slaptažodį.
			 2. Spausti mygtuką registruotis.}\\
			\hline
			\multicolumn{1}{|c|}{{\bfseries Siūlomi duomenys}}&
			{Vardenis Pavardenis, test@gmail.com, test\_client, Naugarduko g. 24-40, test123}\\
			\hline
			...
			\hline
			\multicolumn{1}{|c|}{{\bfseries Vydytojas}}&
			{Eglė Puodžiūnaitė}\\
			\hline
